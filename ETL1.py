...
if (BOCResponse.status_code == 200):
    ...
    expenses = petl.select(expenses,lambda rec: rec.INR != None)

    # add CDN column
    expenses = petl.addfield(expenses,'CAD', lambda rec: decimal.Decimal(rec.INR) * rec.rate)
